...
struct FILEIO_API FileMetaHeader
{
  char signature[4];
...
enum class FILEIO_API FileStreamStatus : uint8
{
...
public:
  ...
  static FileStreamStatus outputText(string&& text);
  static FileStreamStatus inputText(string& text);
